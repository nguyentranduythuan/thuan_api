    ...
    <div class="container-fluid">
	    <div class="card card-default">
	    	@if ($errors->any())
	      	...
	      	<div class="card-body">
	      		<form action="{{ route('v1.item.store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	      			@csrf
	      			<div class="row">
			          	<div class="col-md-6">
                			...
                			<div class="form-group">
			                  ...
			                  <input type="text" name="image_link" value="" placeholder="">
                			</div>
                			<div class="form-group">
			                  <label>BK1</label>
			                  <input type="text" name="bk1" value="" placeholder="">
                			</div>
                			<div class="form-group">
			                  <label>BK2</label>
			                  <input type="text" name="bk2" value="" placeholder="">
                			</div>
                			<div class="form-group">
